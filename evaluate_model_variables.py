...
cf_test_features = cf_test_data.drop(columns=["flight"], errors="ignore")[required_columns]
cg_test_features = cg_test_data.drop(columns=["flight"], errors="ignore")[required_columns]
